...
function aplicarEjemplosCampos() {
  const ejemplos = {
    referencia: "Ej. PRUEBA-CONTROL-001", origenVenta: "Ej. PRUEBA CONTROLADA",
    clienteNumeroId: "Ej. TEST-ID-0001", clienteRfc: "Ej. TEST010101AAA", clienteCurp: "Ej. TEST010101HNLRRS01",
    clienteApellidoPaterno: "Ej. PRUEBA", clienteApellidoMaterno: "Ej. SISTEMA", clienteNombres: "Ej. CLIENTE UNO",
    clienteDomicilio: "Ej. AV. PRUEBAS", clienteNumero: "Ej. 100", clienteColonia: "Ej. CENTRO",
    clienteEstado: "Ej. NUEVO LEON", clienteCp: "Ej. 64000", clienteCiudad: "Ej. MONTERREY", clienteMunicipio: "Ej. MONTERREY",
    clienteTelefono: "Ej. 81 1000 0001", clienteCelular: "Ej. 81 1000 0002", clienteCorreo: "Ej. prueba@ejemplo.com",
    clienteDomicilioAnterior: "Ej. CALLE ANTERIOR 50", clienteAntiguedadDomicilioAnterior: "Ej. 3 AÑOS",
    clienteEdadesDependientes: "Ej. 5, 9", clienteConyuge: "Ej. CLIENTE CONYUGE / NO APLICA",
    laboralEmpresa: "Ej. EMPRESA PRUEBA, S.A. DE C.V.", laboralDomicilio: "Ej. AV. LABORAL", laboralNumero: "Ej. 200",
    laboralColonia: "Ej. OBISPADO", laboralEstado: "Ej. NUEVO LEON", laboralCp: "Ej. 64060", laboralCiudad: "Ej. MONTERREY",
    laboralMunicipio: "Ej. MONTERREY", laboralTelefono: "Ej. 81 2000 0001", laboralExtension: "Ej. 125 / SIN EXTENSION",
    laboralActividad: "Ej. ADMINISTRACION", laboralAntiguedad: "Ej. 5 AÑOS", laboralAntiguedadAnterior: "Ej. 2 AÑOS / NO APLICA",
    sustitutoNombre: "Ej. SUSTITUTO PRUEBA", sustitutoDomicilio: "Ej. AV. SUSTITUTO 300", sustitutoTelefono: "Ej. 81 3000 0001",
    sustitutoParentesco: "Ej. HIJA", sustitutoId: "Ej. TEST-SUST-01",
    referencia1Nombre: "Ej. REFERENCIA FAMILIAR UNO", referencia1Telefono: "Ej. 81 4000 0001", referencia1Celular: "Ej. 81 4000 0002",
    referencia2Nombre: "Ej. REFERENCIA FAMILIAR DOS", referencia2Telefono: "Ej. 81 5000 0001", referencia2Celular: "Ej. 81 5000 0002",
    banco1Nombre: "Ej. BBVA", banco1TipoCuenta: "Ej. DEBITO", banco1NumeroCuenta: "Ej. TEST-CUENTA-01",
    banco2Nombre: "Ej. BANORTE", banco2TipoCuenta: "Ej. NOMINA", banco2NumeroCuenta: "Ej. TEST-CUENTA-02",
    paquete: "Ej. PLAN PRUEBA", descripcionVenta: "Ej. SOLICITUD DE PRUEBA CONTROLADA",
    servicioAtaud: "Ej. ATAUD PRUEBA", servicioUrna: "Ej. URNA PRUEBA / NO APLICA", servicioDuracion: "Ej. 12 HORAS",
    propiedadSeccion: "Ej. PLATINO", propiedadManzana: "Ej. 001", propiedadNumero: "Ej. 025", propiedadClave: "Ej. TEST-PLATINO-001-025",
    finadoNombres: "Ej. FINADO PRUEBA", finadoApellidos: "Ej. CONTROL SISTEMA", finadoParentescoTitular: "Ej. PADRE",
    finadoCausaDefuncion: "Ej. CAUSA DE PRUEBA", finadoProcedencia: "Ej. HOSPITAL DE PRUEBA",
    uiCorresponsableNombres: "Ej. CORRESPONSABLE PRUEBA", uiCorresponsableApellidos: "Ej. CONTROL SISTEMA",
    uiCorresponsableParentesco: "Ej. HIJO", uiCorresponsableCelular: "Ej. 81 6000 0001"
  };
